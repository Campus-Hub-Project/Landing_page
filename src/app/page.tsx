      ...
      <Card className='rounded border-none shadow-lg w-1/2 flex flex-col justify-center bg-hub-white'>
        ...
        <CardContent className='mt-3 flex gap-3'>
          ...
          <Link href=''
            ...
            text-hub-white bg-hub-blue border-hub-blue hover:text-hub-blue hover:bg-hub-white'>
            Para instituições
          </Link>
        </CardContent>
      </Card>
      <Card className='rounded border-none shadow-lg bg-hub-white relative overflow-hidden 
